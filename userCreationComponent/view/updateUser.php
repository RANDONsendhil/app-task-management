        ...
        <div class="container shadow-lg p-3  bg-body-tertiary rounded">
          <form class="row g-2" method="POST" action="/home">
            ...
            <div class="col-12">
              ...
              <input type="text" class="form-control" id="numSS" name="numSS" value="<?php echo $userData['numSS']; ?>">
            </div>
            <div class="col-md-6">
            ...
            <div class="d-grid gap-2 mt-4 d-flex justify-content-end">
              <div class="grid text-center d-inline-flex gap-1">
                ...
                <div class="g-col-4">
                  <input class="btn btn-danger btn-sm" type="submit" name="update-User" value="Modifier">
                </div>
              </div>
            </div>
          </form>
