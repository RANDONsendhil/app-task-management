    ...
    <div class="project-creation-modal-content">
      ...
      <div class="project-creation-modal-body">
        <form id="editProjectForm" method="POST">
          ...
          <div class="project-creation-modal-footer">
            <button type="button" class="project-btn project-btn-secondary" onclick="closeEditProjectModal()">Annuler</button>
            <button type="submit" class="project-btn project-btn-success" id="editProjectSubmitBtn" name="submit-edit-project">Enregistrer</button>
          </div>
        </form>
      </div>
    </div>
            ...
            <?php if (!empty($listProjects)): ?>
              <?php foreach ($listProjects as $row): ?>
                <tr class="project-row"
                  data-project-id="<?php echo htmlspecialchars($row['id']); ?>"
                  ...
                  <td class="project-actions-cell">
                    <div style="display: flex; gap: 4px;">
                      <button class="action-btn" title="Modifier" onclick="event.stopPropagation(); editProject(<?php echo $row['id']; ?>)">
                        ✏️
                      </button>
