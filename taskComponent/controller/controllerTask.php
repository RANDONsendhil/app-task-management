...
class ControllerAppointment
{
    ...
    public function controllerDisplayDocotors()
    {
        $dataDisplayDoctors =  $this->appointmentModel->get_doctors_list();
        require(BASE_PATH . '/appointmentComponent/view/displayDoctors.php');
    }
}