  ...
  <ul class="nav flex-column">
    <li class="nav-item">
      <div id="username-sidebar" class="nav-link" href="#submenu1" aria-expanded="false" aria-controls="submenu1">
        ...
        <div>
          <a class="nav-item" href="/admin/home">
    ...
    <li class="nav-item">
      ...
      <div class="nav-custom-sidebar">
        <ul class="nav flex-column submenu">
          <li><a class="nav-link" href="/admin/home" id="home"><span> <img style="height: 39px;" src="/images/graph.png"
                  alt="" srcset=""></span>
              <span>Tableau de bord Admin</span></a></li>
        </ul>
      </div>
    </li>
    ...
    <li class="nav-item">
      ...
      <div class="nav-custom-sidebar">
        <ul class="nav flex-column submenu">
          <li><a class="nav-link" href="/admin/profil-admin"><span> <img style="height: 39px;"
                  src="/images/person_1.svg" alt="" srcset=""></span><span>Profil Admin</span></a>
          </li>
        </ul>
      </div>
    </li>
